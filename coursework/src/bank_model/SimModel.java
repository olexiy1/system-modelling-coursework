...
public class SimModel {
    public static void main(String[] args) {
        ...
        Dispose buildingDispose = new Dispose("Пішохід обcлужений");

        ExponentialGenerator egCashier1 = new ExponentialGenerator(2.5);
        ExponentialGenerator egCashier2 = new ExponentialGenerator(2.5);

        ExponentialGenerator egBCashier1 = new ExponentialGenerator(2.5);
        ExponentialGenerator egBCashier2 = new ExponentialGenerator(2.5);
        ...
        Dispose dRefuse = new Dispose("Відмова в кредиті");
        Dispose dSuccess = new Dispose("Кредит оформелно");
